...
def list_image_files(directory, extensions=('jpg', 'jpeg', 'png')):
    ...
    for ext in extensions:
        ...
        # También buscar en uppercase
        pattern = os.path.join(directory, f"*.{ext.upper()}")
        files.extend(glob.glob(pattern))
    return sorted(files)

def create_train_val_split(image_dir, output_dir, val_ratio=0.2, copy=True):
    """
    Crea una división entre entrenamiento y validación.

    Args:
        image_dir (str): Directorio con las imágenes originales, organizadas por categorías.
        output_dir (str): Directorio donde se creará la estructura train/ y val/.
        val_ratio (float): Proporción de imágenes que irán a validación (0.0-1.0).
    ...
    for category in categories:
        ...
        # Mover o copiar imágenes de entrenamiento
        ...
        # Mover o copiar imágenes de validación
    ...
    print(f"División completada: {train_count} imágenes de entrenamiento, {val_count} de validación.")
