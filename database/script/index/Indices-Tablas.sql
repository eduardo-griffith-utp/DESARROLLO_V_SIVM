...
CREATE FULLTEXT INDEX ft_item_name_description ON Item (name, description);
...
CREATE INDEX idx_media_date_type ON MediaContent (date_uploaded, type);
...
CREATE INDEX idx_result_date_status ON AnalysisResult (date_analysis, status);
